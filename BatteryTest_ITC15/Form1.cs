...
using ITC.Embedded.Utility;
using ITC.Embedded.WirelessAssembly;
using MS.Embedded.Wireless.Network;
//using HSM.Embedded.Wireless.Network;
//using HSM.Embedded.WirelessAssembly;
#endif
...
namespace Battery_Test
{
    public partial class Form1 : Form
    {
        ...
        void da_DecodeEvent(object sender, DecodeAssembly.DecodeEventArgs e)
        {
        ...
        private void doRefreshOutputStatusDisplay()
        {
            ...
            int akkuLevel = SystemNotification.GetBatteryLife();
        ...
        private void timerExecPhoto_Tick(object sender, EventArgs e)
        {
            ...
            {
                //ee = ee;
                this.doLog("Exception in timerExecPhoto_Tick: "+ ee.Message);
        ...
        private void tabPageConfigFTP_Click(object sender, EventArgs e)
        {
